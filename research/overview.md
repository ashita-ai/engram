...
- [Dynamic and Selective Engrams](https://www.nature.com/articles/s41593-023-01551-w) — Tomé et al., Nature Neuroscience 2024: Memory engrams are dynamic (neurons drop in/out during consolidation) and become selective over time via inhibitory plasticity. Engram's `selectivity_score` field is inspired by this finding. During consolidation, selectivity increases for memories that get linked to new memories or receive evolution updates.
