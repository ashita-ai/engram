...
- [Testing Effect / Retrieval Practice](https://pmc.ncbi.nlm.nih.gov/articles/PMC5912918/) — Roediger & Karpicke 2006: "Repeated remembering strengthens memories much more so than repeated learning." Engram's `consolidation_strength` field is based on this finding. During consolidation, memories that get linked or evolved are strengthened.
